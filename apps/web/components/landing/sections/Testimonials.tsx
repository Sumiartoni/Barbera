...
const t1 = "/testimonial-1.jpg";
const t2 = "/testimonial-2.jpg";
const t3 = "/testimonial-3.jpg";
...
const testimonials = [
  ...
  { img: t3, name: "Yoga Santoso", role: "Owner, The Gentleman Barber", text: "Gua bisa pantau performa barber, omzet harian, sama service paling laku â€” semua dari HP. Worth banget." },
];
