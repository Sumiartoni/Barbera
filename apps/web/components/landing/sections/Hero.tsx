...
const heroImg = "/hero-barber.jpg";
import { RevenueCard, BookingCard, StaffCard, ServiceCard } from "@/components/landing/FloatingCards";
import BarberPole from "@/components/landing/BarberPole";
