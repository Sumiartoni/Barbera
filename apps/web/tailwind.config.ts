  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-slow": { "0%,100%": { transform: "translateY(0px) rotate(-2deg)" }, "50%": { transform: "translateY(-16px) rotate(-2deg)" } },
        "float-delay": { "0%,100%": { transform: "translateY(-8px) rotate(3deg)" }, "50%": { transform: "translateY(8px) rotate(3deg)" } },
        "pulse-glow": { "0%,100%": { boxShadow: "0 0 20px hsl(0 84% 52% / 0.4)" }, "50%": { boxShadow: "0 0 40px hsl(0 84% 52% / 0.7)" } },
