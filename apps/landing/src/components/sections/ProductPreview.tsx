    ...
    <div className="container relative">
      <Reveal className="text-center max-w-2xl mx-auto mb-16">
        ...
        <p className="mt-5 text-lg text-muted-foreground">
          Real-time data untuk setiap keputusan bisnis kamu — dari satu layar.
        </p>
      </Reveal>
                  ...
                  <div className="col-span-12 md:col-span-10 p-5 md:p-6 space-y-4">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <div>
                        ...
                        <div className="font-display font-bold text-base tracking-tight">Bagas Pratama 👋</div>
                      </div>
                      ...
                      <div className="lg:col-span-2 rounded-xl border border-border/60 p-5 bg-card">
                        <div className="flex justify-between items-center mb-4">
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">Last 7 days · Rp 24.5M total</div>
                          </div>
                          <div className="flex items-center gap-2">
